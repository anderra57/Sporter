...
public class InscripcionesWorker extends Worker {

    public InscripcionesWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        try {
            ...
            String direccion = "http://ec2-52-56-170-196.eu-west-2.compute.amazonaws.com/aarias023/WEB/das_grupal/inscripcion.php";
            ...
            if("inscribirse".equals(funcion) || "desapuntar".equals(funcion)) {
